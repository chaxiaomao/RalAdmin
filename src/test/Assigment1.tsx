...
function Assigment1({id, onClose} : AssigmentProps) {
    ...
    return (
        ...
        <div className="modal modal-pos is-active">
            <div className="modal-background modal-background-pos modal-background-06" onClick={onClose}></div>
            <div className="modal-content modal-content-100 animate__animated animate__fadeInDown">
                    ...
                    <XCard>
                        ...
                        <div className="column">
                            <button onClick={handleSubmit}
                                    className={isSubmitting ? 'button is-primary is-loading' : 'button is-primary'}>
